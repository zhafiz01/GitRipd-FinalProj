...
// } from "../services/zylaAPIService"
// import HTTPHandler from "../helpers/HTTPHandler"

// export const fetchMuscleTargets: HTTPHandler = async (
// 	req,
// 	res
// ) => {
// 	try {
...
// 			// check if existing
// 			console.log(
// 				`🔁 Skipping existing: ${exercise.name}`
// 			)
...
// export const fetchExercisesByTarget: HTTPHandler =
// 	async (req, res) => {
// 		const { target } = req.params
// 		const { save } = req.query

// 		try {
// 			const exercises = await getExercisesByTarget(
// 				target
// 			)

// 			if (save) {
// 				const exerciseIds = await saveExercises(
// 					exercises
// 				)
// 				res.status(200).json({
...
// 		} catch (error) {
// 			res.status(500).json({
// 				message: "Error fetching exercises for muscle"
// 			})
// 		}
// 	}

// export const getSavedExercises: HTTPHandler = async (
// 	req,
// 	res
// ) => {
// 	try {
...
// 	} catch (error) {
// 		res.status(500).json({
// 			message: "Failed to retrieve saved exercises"
// 		})
// 	}
// }
...
export const fetchExercisesByTarget: HTTPHandler = async (
	req,
	res
) => {
	const { target } = req.params
